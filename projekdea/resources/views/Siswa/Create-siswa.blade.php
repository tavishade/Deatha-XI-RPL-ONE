          ...
          <div class="card-header">
            ...
            <div class="card-body">
                <form action="{{ route('simpan-siswa') }}" method="post">
                  ...
                  <div class="form-group">
                    <textarea id="nama" name="alamat" class="form-control" placeholder="Alamat Siswa"></textarea>
                  </div>
                  <div class="form-group">
                    <input type="text" id="jenis_kelamin" name="jenis_kelamin" class="form-control" placeholder="Jenis Kelamin">
                  </div>
                  <div class="form-group">
                    <input type="text" id="notlp" name="notelp" class="form-control" placeholder="Nomor Telepon">
                  </div>
                  <div class="form-group">
